...
@interface ReturnBackViewController : UIViewController <NSURLConnHelperDelegate,UITableViewDelegate,UITableViewDataSource,QQSectionHeaderViewDelegate,WordsDelegate,UITextViewDelegate,UsualOpinionDelegate>
...
@property (nonatomic,strong) IBOutlet UIButton *returnBack;

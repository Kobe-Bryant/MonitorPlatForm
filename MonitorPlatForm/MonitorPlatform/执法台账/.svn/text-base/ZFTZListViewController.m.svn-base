...
- (IBAction)searchBtnPressed:(id)sender
{
    ...
    isScroll = NO;
    self.currentPage = 1;
    [self getWebDataWithPageCount:self.currentPage];
}
...
{
    NSDictionary *tmpDic = [infoAry objectAtIndex:indexPath.row];
    ZFTZDetailsViewController *childView = [[[ZFTZDetailsViewController alloc] initWithNibName:@"ZFTZDetailsViewController" bundle:nil] autorelease];
